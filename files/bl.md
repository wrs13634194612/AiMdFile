...
c++使用gstreamer完成摄像+声音
我希望用gstreamer调用电脑的摄像头，拍摄视频，附带声音，默认10秒，自动保存文件到本地
